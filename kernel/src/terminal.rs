...
pub fn draw_desktop(fb: &mut Framebuffer, theme: &Theme, prompt_text: &str, prompt_cursor: usize) {
    draw_wallpaper(fb, theme);
    draw_bar(fb, theme);
    draw_terminal_panel(fb, theme, prompt_text, prompt_cursor);
}
...
fn draw_terminal_panel(fb: &mut Framebuffer, theme: &Theme, prompt_text: &str, prompt_cursor: usize) {
