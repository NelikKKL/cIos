...
//!
//! В main.rs сейчас используется только DEFAULT_THEME, поэтому часть
//! вариантов (SOLID_THEME, BarPosition::Top/Hidden, Wallpaper::Solid,
//! поле BarTheme.foreground) компилятор считает "неиспользуемыми" —
//! это не мёртвый код, а поверхность кастомизации на будущее.
#![allow(dead_code)]
//!
