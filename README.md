...
Пиксель-арт перерисован автором проекта с исходного изображения,
правообладатель и источник которого пока не установлены.

Данная запись не заявляет право собственности на исходное изображение
и не означает, что оно распространяется по лицензии GPL-3.0 или любой
другой лицензии проекта.

Если вы знаете источник или являетесь правообладателем, пожалуйста,
откройте Issue и укажите ссылку на оригинал и условия его использования.
До выяснения источника и разрешения на распространение не следует считать
этот файл свободно лицензированным